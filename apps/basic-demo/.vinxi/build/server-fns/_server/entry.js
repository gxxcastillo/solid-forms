...
var C = ((o2) => (o2[o2.AggregateError = 1] = "AggregateError", o2[o2.ArrowFunction = 2] = "ArrowFunction", o2[o2.ErrorPrototypeStack = 4] = "ErrorPrototypeStack", o2[o2.ObjectAssign = 8] = "ObjectAssign", o2[o2.BigIntTypedArray = 16] = "BigIntTypedArray", o2))(C || {});
function f$1(n2, e) {
  if (!n2)
    throw e;
}
...
function u$1(n2) {
  let e = "", r = 0, t;
  for (let s = 0, o2 = n2.length; s < o2; s++)
...
var b = "__SEROVAL_REFS__", K$1 = "$R";
var Ie = /* @__PURE__ */ new Map(), x$1 = /* @__PURE__ */ new Map();
function Z$1(n2) {
  return Ie.has(n2);
}
function ar(n2) {
...
function Oe(n2) {
  return f$1(ar(n2), new Error("Missing reference for id:" + n2)), x$1.get(n2);
}
typeof globalThis != "undefined" ? Object.defineProperty(globalThis, b, { value: x$1, configurable: true, writable: false, enumerable: false }) : typeof window != "undefined" ? Object.defineProperty(window, b, { value: x$1, configurable: true, writable: false, enumerable: false }) : typeof self != "undefined" ? Object.defineProperty(self, b, { value: x$1, configurable: true, writable: false, enumerable: false }) : typeof global != "undefined" && Object.defineProperty(global, b, { value: x$1, configurable: true, writable: false, enumerable: false });
function wr(n2) {
  return n2;
}
function ze(n2, e) {
...
function O$1(n2, e) {
  let r = dr(n2), t = Object.getOwnPropertyNames(n2);
  for (let s = 0, o2 = t.length, i2; s < o2; s++)
    i2 = t[s], i2 !== "name" && i2 !== "message" && (i2 === "stack" ? e & 4 && (r = r || {}, r[i2] = n2[i2]) : (r = r || {}, r[i2] = n2[i2]));
  return r;
}
function te$1(n2) {
...
function N(n2) {
  return { t: 1, i: void 0, s: u$1(n2), l: void 0, c: void 0, m: void 0, p: void 0, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function se(n2) {
...
function ie(n2, e) {
  return { t: 6, i: n2, s: void 0, l: void 0, c: u$1(e.source), m: e.flags, p: void 0, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function ae$1(n2, e) {
...
function Ee(n2, e) {
  return { t: 18, i: n2, s: u$1(Ce(e)), l: void 0, c: void 0, m: void 0, p: void 0, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function z$1(n2, e, r) {
  return { t: 25, i: n2, s: r, l: void 0, c: u$1(e), m: void 0, p: void 0, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function le(n2, e, r) {
...
function pe(n2, e, r) {
  return { t: 13, i: n2, s: re(e), l: void 0, c: void 0, m: u$1(e.message), p: r, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function me(n2, e, r) {
  return { t: 14, i: n2, s: re(e), l: void 0, c: void 0, m: u$1(e.message), p: r, e: void 0, a: void 0, f: void 0, b: void 0, o: void 0 };
}
function ge(n2, e, r) {
...
function D(n2) {
  ...
  for (; ; )
    try {
      let o2 = s.next();
      if (e.push(o2.value), o2.done) {
        t = e.length - 1;
        break;
      }
    } catch (o2) {
      r = e.length, e.push(o2);
    }
  return { v: e, t: r, d: t };
}
function Le(n2) {
...
function B$1() {
  ...
  return { __SEROVAL_STREAM__: true, on(a) {
    r && n2.add(a);
    for (let l2 = 0, d2 = e.length; l2 < d2; l2++) {
      let g2 = e[l2];
      l2 === d2 - 1 ? t ? a.return(g2) : a.throw(g2) : a.next(g2);
    }
    return () => {
      r && n2.delete(a);
    };
    ...
    r && (e.push(a), o2(a), r = false, t = false, n2.clear());
  }, return(a) {
    r && (e.push(a), i2(a), r = false, t = true, n2.clear());
  } };
}
function be(n2) {
...
function He(n2) {
  return () => {
    let e = [], r = [], t = 0, s = -1, o2 = false;
    function i2() {
      for (let l2 = 0, d2 = r.length; l2 < d2; l2++)
        r[l2].resolve({ done: true, value: void 0 });
    }
    n2.on({ next(l2) {
      let d2 = r.shift();
      d2 && d2.resolve({ done: false, value: l2 }), e.push(l2);
    }, throw(l2) {
      let d2 = r.shift();
      d2 && d2.reject(l2), i2(), s = e.length, e.push(l2), o2 = true;
    }, return(l2) {
      let d2 = r.shift();
      d2 && d2.resolve({ done: true, value: l2 }), i2(), s = e.length, e.push(l2);
    } });
    function a() {
      let l2 = t++, d2 = e[l2];
      if (l2 !== s)
        return { done: false, value: d2 };
      if (o2)
        throw d2;
    ...
    return { [Symbol.asyncIterator]() {
      ...
      if (s === -1) {
        ...
        if (l2 >= e.length) {
          let d2 = J();
          return r.push(d2), await d2.promise;
        }
...
var E$1 = class E {
  ...
  deserializeArray(e) {
    ...
    for (let o2 = 0; o2 < r; o2++)
      s = e.a[o2], s && (t[o2] = this.deserialize(s));
    return qe(t, e.o), t;
  }
  deserializeProperties(e, r) {
    ...
    if (t) {
      let s = e.k, o2 = e.v;
      for (let i2 = 0, a; i2 < t; i2++)
        a = s[i2], typeof a == "string" ? r[S$1(a)] = this.deserialize(o2[i2]) : r[this.deserialize(a)] = this.deserialize(o2[i2]);
    }
    return r;
  }
  deserializeObject(e) {
  ...
  deserializeSet(e) {
    ...
    for (let s = 0, o2 = e.l; s < o2; s++)
      r.add(this.deserialize(t[s]));
    return r;
  }
  deserializeMap(e) {
    let r = this.assignIndexedValue(e.i, /* @__PURE__ */ new Map()), t = e.e.k, s = e.e.v;
    for (let o2 = 0, i2 = e.e.s; o2 < i2; o2++)
      r.set(this.deserialize(t[o2]), this.deserialize(s[o2]));
    return r;
  }
  ...
  deserializeError(e) {
    let r = Ve[e.s], t = this.assignIndexedValue(e.i, new r(S$1(e.m)));
  ...
  deserializePlugin(e) {
    ...
    if (r) {
      let t = S$1(e.c);
      for (let s = 0, o2 = r.length; s < o2; s++) {
        let i2 = r[s];
        if (i2.tag === t)
          return this.assignIndexedValue(e.i, i2.deserialize(e.s, this, { id: e.i }));
      }
    }
...
function fr(n2) {
  let e = [], r = n2[0];
  for (let t = 1, s = n2.length, o2, i2 = r; t < s; t++)
    o2 = n2[t], o2.t === 0 && o2.v === i2.v ? r = { t: 0, s: o2.s, k: void 0, v: G$1(r) } : o2.t === 2 && o2.s === i2.s ? r = { t: 2, s: G$1(r), k: o2.k, v: o2.v } : o2.t === 1 && o2.s === i2.s ? r = { t: 1, s: G$1(r), k: void 0, v: o2.v } : o2.t === 3 && o2.s === i2.s ? r = { t: 3, s: G$1(r), k: o2.k, v: void 0 } : (e.push(r), r = o2), i2 = o2;
  return e.push(r), e;
}
function Ze(n2) {
  if (n2.length) {
...
var pr = "Object.create(null)", mr = "new Set", gr = "new Map", Sr = "Promise.resolve", hr = "Promise.reject", yr = { 3: "Object.freeze", 2: "Object.seal", 1: "Object.preventExtensions", 0: void 0 }, R = class {
  ...
  createAssignment(e, r) {
    this.assignments.push({ t: 0, s: e, k: void 0, v: r });
  }
  createAddAssignment(e, r) {
    this.assignments.push({ t: 1, s: this.getRefParam(e), k: void 0, v: r });
  }
  createSetAssignment(e, r, t) {
    this.assignments.push({ t: 2, s: this.getRefParam(e), k: r, v: t });
  }
  createDeleteAssignment(e, r) {
    this.assignments.push({ t: 3, s: this.getRefParam(e), k: r, v: void 0 });
  }
  ...
  serializeReference(e) {
    return this.assignIndexedValue(e.i, b + '.get("' + e.s + '")');
  }
  ...
  serializeArray(e) {
    ...
    if (e.l) {
      this.stack.push(r);
      let t = e.a, s = this.serializeArrayItem(r, t[0], 0), o2 = s === "";
      for (let i2 = 1, a = e.l, l2; i2 < a; i2++)
        l2 = this.serializeArrayItem(r, t[i2], i2), s += "," + l2, o2 = l2 === "";
      return this.stack.pop(), this.pushObjectFlag(e.o, e.i), this.assignIndexedValue(r, "[" + s + (o2 ? ",]" : "]"));
    }
    return this.assignIndexedValue(r, "[]");
  }
  serializeProperty(e, r, t) {
    if (typeof r == "string") {
      let s = Number(r), o2 = s >= 0 || we(r);
      if (this.isIndexedValueInStack(t)) {
        let i2 = this.getRefParam(t.i);
        return this.markRef(e.i), o2 && s !== s ? this.createObjectAssign(e.i, r, i2) : this.createArrayAssign(e.i, o2 ? r : '"' + r + '"', i2), "";
      }
      return (o2 ? r : '"' + r + '"') + ":" + this.serialize(t);
    }
  ...
  serializeProperties(e, r) {
    ...
    if (t) {
      let s = r.k, o2 = r.v;
      this.stack.push(e.i);
      let i2 = this.serializeProperty(e, s[0], o2[0]);
      for (let a = 1, l2 = i2; a < t; a++)
        l2 = this.serializeProperty(e, s[a], o2[a]), i2 += (l2 && i2 && ",") + l2;
  ...
  serializeStringKeyAssignment(e, r, t, s) {
    let o2 = this.serialize(s), i2 = Number(t), a = i2 >= 0 || we(t);
    if (this.isIndexedValueInStack(s))
      a && i2 !== i2 ? this.createObjectAssign(e.i, t, o2) : this.createArrayAssign(e.i, a ? t : '"' + t + '"', o2);
    else {
      let l2 = this.assignments;
      this.assignments = r, a ? this.createObjectAssign(e.i, t, o2) : this.createArrayAssign(e.i, a ? t : '"' + t + '"', o2), this.assignments = l2;
    }
  }
  serializeAssignment(e, r, t, s) {
    if (typeof t == "string")
      ...
      this.assignments = r, this.createArrayAssign(e.i, this.serialize(t), i2), this.assignments = a;
    }
  }
  serializeAssignments(e, r) {
    ...
    if (t) {
      ...
      this.stack.push(e.i);
      for (let a = 0; a < t; a++)
        this.serializeAssignment(e, s, o2[a], i2[a]);
  ...
  serializeSet(e) {
    ...
    if (t) {
      let o2 = e.a;
      this.stack.push(s);
      let i2 = this.serializeSetItem(s, o2[0]);
      for (let a = 1, l2 = i2; a < t; a++)
        l2 = this.serializeSetItem(s, o2[a]), i2 += (l2 && i2 && ",") + l2;
  ...
  serializeMapEntry(e, r, t, s) {
    if (this.isIndexedValueInStack(r)) {
      let o2 = this.getRefParam(r.i);
      if (this.markRef(e), this.isIndexedValueInStack(t)) {
        let a = this.getRefParam(t.i);
        return this.createSetAssignment(e, o2, a), "";
      }
      if (t.t !== 4 && t.i != null && this.isMarked(t.i)) {
        let a = "(" + this.serialize(t) + ",[" + s + "," + s + "])";
        return this.createSetAssignment(e, o2, this.getRefParam(t.i)), this.createDeleteAssignment(e, s), a;
      }
      let i2 = this.stack;
      return this.stack = [], this.createSetAssignment(e, o2, this.serialize(t)), this.stack = i2, "";
    }
    if (this.isIndexedValueInStack(t)) {
      let o2 = this.getRefParam(t.i);
      if (this.markRef(e), r.t !== 4 && r.i != null && this.isMarked(r.i)) {
        let a = "(" + this.serialize(r) + ",[" + s + "," + s + "])";
        return this.createSetAssignment(e, this.getRefParam(r.i), o2), this.createDeleteAssignment(e, s), a;
      }
      let i2 = this.stack;
      return this.stack = [], this.createSetAssignment(e, this.serialize(r), o2), this.stack = i2, "";
    }
    return "[" + this.serialize(r) + "," + this.serialize(t) + "]";
  }
  serializeMap(e) {
    let r = gr, t = e.e.s, s = e.i, o2 = e.f, i2 = this.getRefParam(o2.i);
    if (t) {
      let a = e.e.k, l2 = e.e.v;
      this.stack.push(s);
      let d2 = this.serializeMapEntry(s, a[0], l2[0], i2);
      for (let g2 = 1, Ae = d2; g2 < t; g2++)
        Ae = this.serializeMapEntry(s, a[g2], l2[g2], i2), d2 += (Ae && d2 && ",") + Ae;
      this.stack.pop(), d2 && (r += "([" + d2 + "])");
    }
    return o2.t === 26 && (this.markRef(o2.i), r = "(" + this.serialize(o2) + "," + r + ")"), this.assignIndexedValue(s, r);
  }
  serializeArrayBuffer(e) {
    let r = "new Uint8Array(", t = e.s, s = t.length;
    if (s) {
      r += "[" + t[0];
      for (let o2 = 1; o2 < s; o2++)
        r += "," + t[o2];
      r += "]";
    }
    return this.assignIndexedValue(e.i, r + ").buffer");
  ...
  serializePromise(e) {
    let r, t = e.f, s = e.i, o2 = e.s ? Sr : hr;
    if (this.isIndexedValueInStack(t)) {
      let i2 = this.getRefParam(t.i);
      r = o2 + (e.s ? "().then(" + this.createFunction([], i2) + ")" : "().catch(" + this.createEffectfulFunction([], "throw " + i2) + ")");
    } else {
      this.stack.push(s);
      let i2 = this.serialize(t);
      this.stack.pop(), r = o2 + "(" + i2 + ")";
    }
    return this.assignIndexedValue(s, r);
  }
  serializeWellKnownSymbol(e) {
    return this.assignIndexedValue(e.i, Te[e.s]);
  }
  serializeBoxed(e) {
  ...
  serializePlugin(e) {
    ...
    if (r)
      for (let t = 0, s = r.length; t < s; t++) {
        let o2 = r[t];
        if (o2.tag === e.c)
          return this.assignIndexedValue(e.i, o2.serialize(e.s, this, { id: e.i }));
      }
    throw new Error('Missing plugin for tag "' + e.c + '".');
  }
  getConstructor(e) {
  ...
  serializeAsyncIteratorFactory(e) {
    ...
    let o2 = this.assignIndexedValue(e.i, this.createFunction(["s"], this.createFunction(["b", "c", "p", "d", "e", "t", "f"], "(b=[],c=0,p=[],d=-1,e=!1,f=" + this.createEffectfulFunction(["i", "l"], "for(i=0,l=p.length;i<l;i++)p[i].s({done:!0,value:void 0})") + ",s.on({next:" + this.createEffectfulFunction(["v", "t"], "if(t=p.shift())t.s({done:!1,value:v});b.push(v)") + ",throw:" + this.createEffectfulFunction(["v", "t"], "if(t=p.shift())t.f(v);f(),d=b.length,e=!0,b.push(v)") + ",return:" + this.createEffectfulFunction(["v", "t"], "if(t=p.shift())t.s({done:!0,value:v});f(),d=b.length,b.push(v)") + "}),t={[" + this.getRefParam(t.i) + "]:" + this.createFunction([], "t") + ",next:" + this.createEffectfulFunction(["i", "t", "v"], "if(d===-1){return((i=c++)>=b.length)?(p.push(t=" + this.getRefParam(r.i) + "()),t):{done:!0,value:b[i]}}if(c>d)return{done:!0,value:void 0};if(v=b[i=c++],i!==d)return{done:!1,value:v};if(e)throw v;return{done:!0,value:v}") + "})")));
    return s ? s + o2 + ")" : o2;
  }
  ...
  serializeStreamConstructor(e) {
    ...
    if (t) {
      ...
      for (let o2 = 1; o2 < t; o2++)
        s += "," + this.serialize(e.a[o2]);
...
var m$1 = class m extends V$1 {
  ...
  parseProperties(e) {
    ...
    for (let i2 = 0, a = r.length; i2 < a; i2++)
      t.push(u$1(r[i2][0])), s.push(this.parse(r[i2][1]));
    let o2 = Symbol.iterator;
    return o2 in e && (t.push(this.parseWellKnownSymbol(o2)), s.push(T(this.parseIteratorFactory(), this.parse(D(e))))), o2 = Symbol.asyncIterator, o2 in e && (t.push(this.parseWellKnownSymbol(o2)), s.push(k(this.parseAsyncIteratorFactory(), this.parse(B$1())))), o2 = Symbol.toStringTag, o2 in e && (t.push(this.parseWellKnownSymbol(o2)), s.push(N(e[o2]))), o2 = Symbol.isConcatSpreadable, o2 in e && (t.push(this.parseWellKnownSymbol(o2)), s.push(e[o2] ? y : v)), { k: t, v: s, s: t.length };
  }
  parsePlainObject(e, r, t) {
    return this.createObjectNode(e, r, t, this.parseProperties(r));
  }
  parseBoxed(e, r) {
    return de(e, this.parse(r.valueOf()));
  }
  parseTypedArray(e, r) {
    return ue(e, r, this.parse(r.buffer));
  }
  ...
  parseMap(e, r) {
    let t = [], s = [];
    for (let [o2, i2] of r.entries())
      t.push(this.parse(o2)), s.push(this.parse(i2));
  ...
  parsePlugin(e, r) {
    ...
    if (t)
      for (let s = 0, o2 = t.length; s < o2; s++) {
        let i2 = t[s];
        if (i2.parse.sync && i2.test(r))
          return z$1(e, i2.tag, i2.parse.sync(r, this, { id: e }));
      }
  }
  parseStream(e, r) {
  ...
  parseObject(e, r) {
    ...
    if (o2 & 1 && typeof AggregateError != "undefined" && (s === AggregateError || r instanceof AggregateError))
...
var P = class extends R {
  ...
  serializeTop(r) {
    ...
    if (s == null)
      return t;
    let o2 = this.resolvePatches(), i2 = this.getRefParam(s), a = this.scopeId == null ? "" : K$1, l2 = o2 ? t + "," + o2 + i2 : t;
    if (a === "")
      return o2 ? "(" + l2 + ")" : l2;
    let d2 = this.scopeId == null ? "()" : "(" + K$1 + '["' + u$1(this.scopeId) + '"])';
    return "(" + this.createFunction([a], l2) + ")" + d2;
  }
};
var $ = class extends m$1 {
  ...
  parseProperties(r) {
    let t = Object.entries(r), s = [], o2 = [];
    for (let a = 0, l2 = t.length; a < l2; a++)
      s.push(u$1(t[a][0])), o2.push(this.parse(t[a][1]));
    let i2 = Symbol.iterator;
    return i2 in r && (s.push(this.parseWellKnownSymbol(i2)), o2.push(T(this.parseIteratorFactory(), this.parse(D(r))))), i2 = Symbol.asyncIterator, i2 in r && (s.push(this.parseWellKnownSymbol(i2)), o2.push(k(this.parseAsyncIteratorFactory(), this.parse(be(r))))), i2 = Symbol.toStringTag, i2 in r && (s.push(this.parseWellKnownSymbol(i2)), o2.push(N(r[i2]))), i2 = Symbol.isConcatSpreadable, i2 in r && (s.push(this.parseWellKnownSymbol(i2)), o2.push(r[i2] ? y : v)), { k: s, v: o2, s: s.length };
  }
  parsePromise(r, t) {
    return t.then((s) => {
      let o2 = this.parseWithError(s);
      o2 && this.onParse({ t: 23, i: r, s: void 0, l: void 0, c: void 0, m: void 0, p: void 0, e: void 0, a: [this.parseSpecialReference(2), o2], f: void 0, b: void 0, o: void 0 }), this.popPendingState();
    }, (s) => {
      if (this.alive) {
        let o2 = this.parseWithError(s);
        o2 && this.onParse({ t: 24, i: r, s: void 0, l: void 0, c: void 0, m: void 0, p: void 0, e: void 0, a: [this.parseSpecialReference(3), o2], f: void 0, b: void 0, o: void 0 });
      }
  ...
  parsePlugin(r, t) {
    let s = this.plugins;
    if (s)
      for (let o2 = 0, i2 = s.length; o2 < i2; o2++) {
        let a = s[o2];
  ...
  parseStream(r, t) {
    ...
    return this.pushPendingState(), t.on({ next: (o2) => {
      if (this.alive) {
        let i2 = this.parseWithError(o2);
        i2 && this.onParse(Se(r, i2));
      }
    }, throw: (o2) => {
      if (this.alive) {
        let i2 = this.parseWithError(o2);
        i2 && this.onParse(he(r, i2));
      }
      this.popPendingState();
    }, return: (o2) => {
      if (this.alive) {
        let i2 = this.parseWithError(o2);
        i2 && this.onParse(ye(r, i2));
      }
      this.popPendingState();
    } }), s;
  }
...
function tr(n2, e) {
  let r = c(e.plugins), t = new U({ plugins: r, refs: e.refs, disabledFeatures: e.disabledFeatures, onParse(s, o2) {
    let i2 = new P({ plugins: r, features: t.features, scopeId: e.scopeId, markedRefs: t.marked }), a;
    try {
      a = i2.serializeTop(s);
    } catch (l2) {
...
var o = {}, V2 = wr({ tag: "seroval-plugins/web/ReadableStreamFactory", test(e) {
  return e === o;
}, parse: { sync() {
}, async async() {
  return await Promise.resolve(void 0);
...
var G = wr({ tag: "seroval/plugins/web/ReadableStream", extends: [V2], test(e) {
...
async function handleServerFunction(event) {
  ...
  if (contentType.startsWith("multipart/form-data") || contentType.startsWith("application/x-www-form-urlencoded")) {
    ...
    parsed = yn(await readBody(event), {
      plugins: [F, B, O, A, i, l, Q, Z, ee, te]
    });
  }
  try {
